---@class nulVim.utils.root
local M = {}

---@alias nulRootFn fun(buf: number): (string|string[])
---@alias nulRootSpec string|string[]|nulRootFn

---@class nulRoot
---@field paths string[]
---@field spec nulRootSpec
...
---@param opts? { buf?: number, spec?: nulRootSpec[], all?: boolean }
function M.detect(opts)
  opts = opts or {}
  opts.spec = opts.spec or type(vim.g.root_spec) == "table" and vim.g.root_spec or M.spec
  opts.buf = (opts.buf == nil or opts.buf == 0) and vim.api.nvim_get_current_buf() or opts.buf

  local ret = {} ---@type nulRoot[]
...
function M.get(opts)
  ...
  return nulVim.is_win() and ret:gsub("/", "\\") or ret
end
